    ...
    stages {
        ...
        stage('Deploy to K8s') {
            steps {
                ...
                sh "sshpass -p ${password} scp -o StrictHostKeyChecking=no node-app-pod.yml root@192.168.136.21:~ "
                sh "sshpass -p ${password} scp -o StrictHostKeyChecking=no services.yml root@192.168.136.21:~ "
